...
dat1a = rbind(Parse(Res1a, "Low Skew", "Mid Mean", "Equal Exposure"), 
	          Parse(Res2a, "Mid Skew", "Mid Mean", "Equal Exposure"),
	          Parse(Res3a, "High Skew", "Mid Mean", "Equal Exposure"))
