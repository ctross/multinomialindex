...
df3 <-df2[which(df2$Variable %in% c("N_Males_Offset", "N_Females_Offset","Copulations_Offset","Season_Duration_Offset","Estrous_Duration_Offset","Estrous_Overlap_Offset")),]
...
df4 <-df2[which(!df2$Variable %in% c("N_Males_Offset", "N_Females_Offset","Copulations_Offset","Season_Duration_Offset","Estrous_Duration_Offset","Estrous_Overlap_Offset")),]
