...
M_index_stan(d$rs[which(d$group=="AFROCOLOMBIAN" & d$sex=="M")],d$age[which(d$group=="AFROCOLOMBIAN" & d$sex=="M")],adapt_delta=0.995,samples = 8000,warmup = 4000,chains=4) 
...
M_index_stan(d$rs[which(d$group=="AFROCOLOMBIAN" & d$sex=="F")],d$age[which(d$group=="AFROCOLOMBIAN" & d$sex=="F")],adapt_delta=0.995,samples = 8000,warmup = 4000,chains=4)
...
M_index_stan(d$rs[which(d$group=="EMBERA" & d$sex=="M")],d$age[which(d$group=="EMBERA" & d$sex=="M")],adapt_delta=0.995,samples = 8000,warmup = 4000,chains=4)
...
M_index_stan(d$rs[which(d$group=="EMBERA" & d$sex=="F")],d$age[which(d$group=="EMBERA" & d$sex=="F")],adapt_delta=0.995,samples = 8000,warmup = 4000,chains=4)
...
ggsave("EmpRes.pdf",p1,height=3.5,width=11.5)




ggsave("Trace_E_K_M.pdf",traceplot(StanResults_K_Male,pars=c("gamma", "Concentration", "M_raw", "M", "M_raw_age", "M_age","alpha[1]","alpha[5]","alpha[10]")),height=4,width=12)    
ggsave("Trace_E_K_F.pdf",traceplot(StanResults_K_Female,pars=c("gamma", "Concentration", "M_raw", "M", "M_raw_age", "M_age","alpha[1]","alpha[5]","alpha[10]")),height=4,width=12)       

ggsave("Trace_E_A_M.pdf",traceplot(StanResults_A_Male,pars=c("gamma", "Concentration", "M_raw", "M", "M_raw_age", "M_age","alpha[1]","alpha[5]","alpha[10]")),height=4,width=12)       
ggsave("Trace_E_A_F.pdf",traceplot(StanResults_A_Female,pars=c("gamma", "Concentration", "M_raw", "M", "M_raw_age", "M_age","alpha[1]","alpha[5]","alpha[10]")),height=4,width=12)      

ggsave("Trace_E_E_M.pdf",traceplot(StanResults_E_Male,pars=c("gamma", "Concentration", "M_raw", "M", "M_raw_age", "M_age","alpha[1]","alpha[5]","alpha[10]")),height=4,width=12)   
ggsave("Trace_E_E_F.pdf",traceplot(StanResults_E_Female,pars=c("gamma", "Concentration", "M_raw", "M", "M_raw_age", "M_age","alpha[1]","alpha[5]","alpha[10]")),height=4,width=12)   
